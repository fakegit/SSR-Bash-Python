...
cd /usr/local
git clone https://github.com/rptec/shadowsocksr.git
git clone https://github.com/rptec/SSR-Bash-Python.git
...
wget -N --no-check-certificate -O /usr/local/bin/ssr https://raw.githubusercontent.com/rptec/SSR-Bash-Python/master/ssr
...
echo 'Telegram Group: https://t.me/fulicf'
echo 'Github: https://github.com/rptec'
echo 'QQ :81221809'
